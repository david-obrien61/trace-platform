...
export const CUSTOMER_INSERT_COLUMNS = [
  ...
  'email', 'phone',
  // ✏️ THE LEGACY FOUR ARE GONE (ledger #335). This list carried BOTH sets and the payload below
  // wrote one source value into both — a THIRD hand-maintained copy of the D-41 mirror, after
  // `CUSTOMER_BILLING_MIRROR` and `customerUpsert`'s `CANONICAL`. One column set now.
