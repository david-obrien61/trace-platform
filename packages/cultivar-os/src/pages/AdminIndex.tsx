...
import { Building2, FileText, Landmark, Shield, Calculator, PlusCircle, Wrench, CreditCard, ClipboardList, Ruler } from 'lucide-react';
...
const CARD_META: Record<string, { icon: LucideIcon; description: string }> = {
  ...
  nav_container_sizes:  { icon: Ruler,      description: 'The container sizes you grow and sell — their volume, handling time and install T-posts.' },
