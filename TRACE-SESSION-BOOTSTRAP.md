...
- 🔴 **NO LIVE DB READ WAS POSSIBLE — `SUPABASE_SERVICE_KEY` is EMPTY in both env files** (#183's blocker, third recurrence in five days). **Every figure above is [STATED], not measured (#223)** — the code hardcodes none of them.
