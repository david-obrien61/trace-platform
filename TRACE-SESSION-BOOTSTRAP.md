...
- 🟡 **#350 (2026-09-17) — THE LOAD LIST PRINTS AN ALLOW-LIST · BUILDER-COMPLETE on `feat/load-list-allow-list`, NOT MERGED** · David's five changes after running CARD 19 live: charges/discounts print nowhere · one "could not work out" section · Plant Your Tree is work on a stop · deer fence silent unless marked · figures on their own page · **Saturday 09-19 totals unchanged (27 trees · 7 yd · 54 posts)** · owed: load-list CARDS 3, 5, 12, 13, 15, 19 → `docs/CLOSE-OUT-LEDGER.md` #350
