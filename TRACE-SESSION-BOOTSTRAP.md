...
- 🔴 Tech-debt **#281** — **§6 r7 itself** says the tile grid is *"desktop/tablet only (768px+)"*; it breaks at 640/1024 and renders **4 columns on a phone**. **David rules: stale prose, or unimplemented intent?** It decides what the dashboard does on a phone, and the next mobile pass reads that rule.
