...
- 🟡 **BUILDER-COMPLETE on `main` (`8db220b`, pushed) · TWO MIGRATIONS WRITTEN, NEITHER APPLIED · 12 owner-test cards, 0 COVERED** · `verify` exit 0 ZERO NET-NEW, unpiped · **91/91 files, 4976 assertions** · **16 mutants, 16 caught** · NEW cap **capR2** with an 11-probe `--self-test` · **api/ 12/12 · TWO new permission strings, backfilled in the same transaction** → `docs/owner-tests/owner-id-policy-repoint-full-surface-test.md`
