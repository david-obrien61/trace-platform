...
const MUTANTS = [
  ...
  { id: 'C15', target: LIB,
    why: '🔴 A BILLED TREE BUBBLER PRINTS AGAIN — bubblers are already counted one per tree, so the sheet would demand them twice (tech-debt #326 is the gap this exception leaves)',
    from: "  { re: /^tree bubblers?\\b/i,             why: 'a bubbler line — bubblers are counted per tree above' }, // 5\n  { re: /^TB$/,                           why: 'a bubbler line — bubblers are counted per tree above' },",
    to:   "  { re: /^never-matches-a$/,              why: 'a bubbler line — bubblers are counted per tree above' },\n  { re: /^never-matches-b$/,              why: 'a bubbler line — bubblers are counted per tree above' }," },
  { id: 'C11', target: LIB,
