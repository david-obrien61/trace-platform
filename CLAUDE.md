...
# Last updated: 2026-07-20 — D-50 Layer 2A-2: the order path writes events to the ledger (ledger #143; migration GATED, owner-prove owed). See §3 for the current handoff; `docs/handoff-archive.md` for full history.
