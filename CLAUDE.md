...
# Last updated: 2026-07-21 — D-52: the three-number inventory model in code; decrement moves checkout → fulfillment (ledger #144; owner-prove owed). See §3 for the current handoff; `docs/handoff-archive.md` for full history.
