...
# Last updated: 2026-07-17 — OP-15 RATIFIED: owner-prove STEP ZERO = confirm the deploy for THIS SHA is READY before any observation is evidence (from tech-debt #60); homed on the board where David stands. SHA-stamp mechanical form OPEN (~30 min). See §3 for the current handoff; `docs/handoff-archive.md` for full history.
