...
# Last updated: 2026-07-16 (THUNDER QBO CUSTOMER IDENTITY — the three-way rule replaces the email-only match that cross-billed NINE real invoices to the wrong person over two months; D-47 committed `f7669c3`; **STD-019 ACTIVATED** (v2.4); CLOSES tech-debt #53, records #54/#55; ledger #130). PRIOR: 2026-07-15 (THUNDER D-46 owner-prove follow-on — 3 defects fixed in one pass: SKU edit-persist bug, add-size SKU lineage, engine-level left-pinned row actions; implements D-46 + STD-011, NO new decision; ledger #127). Latest handoff state lives in §3 below; full history in the archive.
