...
# Last updated: 2026-07-29 — the WRITE-PATH CAP ships, ratcheted + chained; it found TWO tables nothing in source revealed (`audit_log`, `business_inventory_ledger`), and the ONE customer form was writing nothing. See §3.
