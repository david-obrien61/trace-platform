...
# Last updated: 2026-07-20 — dev surfaces owner-gated + version stamp always-visible (ledger #142; typed flags removed, no pre-login mount; owner-prove owed, #60 still open). See §3 for the current handoff; `docs/handoff-archive.md` for full history.
