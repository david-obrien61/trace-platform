...
# Last updated: 2026-07-16 (THUNDER QBO CUSTOMER IDENTITY — the three-way rule replaces the email-only match that cross-billed NINE real invoices to the wrong person over two months; D-47 proposed, proposes STD-019, CLOSES tech-debt #53; ledger #130). PRIOR: 2026-07-15 (THUNDER D-46 owner-prove follow-on — 3 defects fixed in one pass: SKU edit-persist bug, add-size SKU lineage, engine-level left-pinned row actions; implements D-46 + STD-011, NO new decision; ledger #127). Latest handoff state lives in §3 below; full history in the archive.
...
### 2026-07-16 — THUNDER QBO CUSTOMER IDENTITY: the THREE-WAY rule replaces the email-only match — the fix for the cross-identity billing scar (NINE real invoices billed to the wrong person over two months); D-47 proposed, proposes STD-019, CLOSES tech-debt #53; BUILDER-COMPLETE, owner-proof owed; ZERO migration, ZERO api-fn (12/12)
