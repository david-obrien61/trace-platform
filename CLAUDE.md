...
# Last updated: 2026-07-22 — 2B DEFECT FIX: reconcile replay counted a POSITION as a MOVEMENT (ledger #146; the reported double-read hypothesis was WRONG); checkout picker now shows AVAILABLE. See §3 for the current handoff; `docs/handoff-archive.md` for full history.
