...
# Last updated: 2026-07-17 — OP-14 RATIFIED (owner-test coverage) + the whole CAPTURE-INDEX swept (59 canonical decisions, 21 missing rows filled, 0 stale); the finding: a doctrine corpus that cannot say what is in it (tech-debt #63, the index has no gate). See §3 for the current handoff; `docs/handoff-archive.md` for full history.
