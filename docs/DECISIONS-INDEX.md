...
| OP-14 | A surface without a test is a claim, not a capability — every surface change touches its owner-test card (or marks it `needs-test`); a moved surface flips green→amber; Thunder never marks `covered` — **PROPOSED 2026-07-16 (ledger #136)** |
