...
**Last updated:** 2026-07-16 (**OP-13 ✅ RATIFIED — David, 2026-07-16; N=3 stands** — and its first LIVE test, the close-out after the one that wrote it, PASSED: 1 entry archived byte-identical, archive 179 → 180, §3 held at 3, line 3 still a pointer. **Amendment PROPOSED: switch the ~600 budget from LINES to CHARACTERS** — OP-13's own finding proved lines are a bad proxy (line 3 was ONE line and ~1,400 tokens, invisible to the metric hunting it). **Ledger #135 — the four ways a working variety got broken through the UI; NO new decision** (implements D-49 + D-46 + STD-011). **Ledger #74's CASE 5 is now CONFIRMED-LIVE, not theoretical.** See the drift-watch line and §5 — this line is a POINTER, not a summary.)
