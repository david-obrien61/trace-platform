...
**Date captured:** 2026-07-16 · **Status:** PROPOSED — awaiting David's ratification (N=3 is his call). First applied same session: 14 entries → 12 archived verbatim (SHA-verified byte-identical) + 2 kept + 1 new = 3; archive 167 → 179; ledger #134.
