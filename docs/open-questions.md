...
- 🟡 **ONE PRICE ON THE `3/5 gal` RUNG COVERS 88 MORE LOTS** — the highest-value number left, and Lauren's sheet does not price it. 267 of LAWNS's 632 live lots would ask for a typed amount today. Owner: ledger #386.
