...
**#393 — provenance at the till (built, migration HELD)**
- 🔴 **APPLY `20260923m_inventory_qty_provenance.sql`.** Until then every row reads `basis unknown` — correct, not a failure. ⚠️ V6 is **expected to ERROR** (`23514`); that error is the pass. Owner: ledger #393.
