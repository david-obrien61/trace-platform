...
- ⚠️ **NOT MINE TO MOVE — `R-155` IS ALSO CLAIMED BY `origin/feat/container-ladder` (#326), 28 MINUTES LATER**, so [[R-148]] clause (4) puts the renumber on them. **`npm run verify` stays red on that one clause until they do.** Owns: `docs/RULINGS.md`.
