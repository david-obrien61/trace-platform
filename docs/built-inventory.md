...
- **Owner-proof owed (on phone, the last bar):** snap the Marcus Webb invoice → check "Schedule delivery" → confirm → Marcus Webb lands under Jun 25, 2026 in the day view → "Route this day" plots the stop on the Google Maps URL.
