...
<!-- Last verified: 2026-06-14 (Receipt Keeper: editable line-item grid + live reconciliation + conflict dialog/override recording (Tesla bit); migration 20260614_receipts_reconciliation.sql written + committed; build 2180 ✅; three 2026-06-13 migrations + one 2026-06-14 migration all pending David apply; live grid test required before advancing to WORKS) -->
